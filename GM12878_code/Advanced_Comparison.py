...
model1.load_weights('new_gm12878_SMC.h5')
...
# 评估模型
model2.load_weights('chinn_gm12878_SMC.h5')
...
model3.load_weights('Trans_gm12878_SMC.h5')
...
model4.load_weights('MDLF_gm12878_SMC.h5')
...
model5.load_weights('CLNNloop_gm12878_SMC.h5')
