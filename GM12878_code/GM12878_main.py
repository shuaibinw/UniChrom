...
checkpointer = ModelCheckpoint(filepath='new_gm12878_SMC.h5', verbose=1, save_best_only=True)
...
open('new_gm12878_SMC.json','w').write(json_string)
model.save_weights('new_gm12878_SMC.h5')
