...
model1.load_weights('new_imr90_SMC.h5')
...
# 评估模型
model2.load_weights('chinn_imr90_SMC.h5')
...
model3.load_weights('Trans_imr90_SMC.h5')
...
model4.load_weights('MDLF_imr90_SMC.h5')
...
model5.load_weights('CLNNloop_imr90_SMC.h5')
