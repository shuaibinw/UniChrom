...
checkpointer = ModelCheckpoint(filepath='new_imr90_SMC.h5', verbose=1, save_best_only=True)
...
open('new_imr90_SMC.json','w').write(json_string)
model.save_weights('new_imr90_SMC.h5')

model.load_weights('new_imr90_SMC.h5')
