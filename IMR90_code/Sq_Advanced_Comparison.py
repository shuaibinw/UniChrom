...
# 评估模型
model1.load_weights('SPEID_imr90_seq_SMC.h5')
...
# 评估模型
model2.load_weights('new_imr90_sq_SMC.h5')
...
X_en_test = np.load('imr90_anchor1_ts.npy')
X_pr_test = np.load('imr90_anchor2_ts.npy')
y_test = np.load('imr90_labels_test_1.npy')
...
# 评估模型
model3.load_weights('imr90_EPIHilbert.h5')
...
model_path = 'saved_models/imr90_gradient_boosting_model.pkl'
...
# 加载测试数据
anchors1_data_test = np.load('imr90_features_test_1.npy')
anchors2_data_test = np.load('imr90_features_test_2.npy')
test_labels = np.load('imr90_labels_test_1.npy')
...
knn_predictor = joblib.load("imr90_knn_predictor.pkl")
xgb_predictor = joblib.load("imr90_xgb_predictor.pkl")
lgb_predictor = joblib.load("imr90_lgb_predictor.pkl")
lr_predictor = joblib.load("imr90_lr_predictor.pkl")
